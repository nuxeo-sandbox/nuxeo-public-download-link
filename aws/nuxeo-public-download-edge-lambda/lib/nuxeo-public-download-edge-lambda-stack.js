...
class NuxeoPublicDownloadEdgeLambdaStack extends cdk.Stack {
  /**
   *
  ...
  constructor(scope, id, props) {
    ...
    const role = new iam.Role(this, 'NuxeoPublicDownloadLambdaRole', {
...
module.exports = {
  NuxeoPublicDownloadEdgeLambdaStack
}
